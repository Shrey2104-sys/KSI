...
const SEED_COURSES = [
  {
    course_id: 'NSSTA-GIS-301',
    title: 'Geospatial Analytics & Small Area Estimation (QGIS/GeoPandas)',
  ...
  {
    course_id: 'MEITY-DPDP-102',
    title: 'DPDP Act 2023 Statutory Compliance for Microdata Custody',
  ...
  {
    course_id: 'IGOT-MGT-201',
    title: 'Public Decision Making & Macro Policy Interventions',
    domain: 'Managerial & Public Decision Making',
    provider: 'Karmayogi Bharat / LBSNAA',
    duration_hours: 15,
    level: 'Intermediate',
    competency_gain: 15,
  },
